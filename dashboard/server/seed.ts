...
export async function seedDatabase() {
  ...
  await db.insert(roles).values([
    ...
    { externalId: "role-003", name: "Security Officer", description: "Security-focused role with access to audit logs, evidence settings, integrity checks, and escalation review", permissions: (["audit.view", "audit.export", "integrity.verify", "evidence.view", "escalations.review", "sessions.view", "traces.view", "policies.view"]), isSystem: true, memberCount: 2, createdAt: d(180) },
    ...
    { externalId: "role-006", name: "Evidence Reviewer", description: "Restricted access for external or internal reviewers to evidence data and audit trails", permissions: (["audit.view", "audit.export", "evidence.view", "integrity.verify"]), isSystem: false, memberCount: 2, createdAt: d(60) },
  ...
  await db.insert(groups).values([
    ...
    { externalId: "grp-002", name: "Security Team", description: "Information security and governance review team", memberCount: 4, roles: (["Security Officer", "Evidence Reviewer"]), permissionLevel: "admin", createdAt: d(150), syncSource: "LDAP", lastSynced: m(30) },
    ...
    { externalId: "grp-005", name: "External Auditors", description: "Third-party audit and evidence review team", memberCount: 2, roles: (["Evidence Reviewer"]), permissionLevel: "read", createdAt: d(60), syncSource: "Manual", lastSynced: isoNow },
  ...
  await db.insert(users).values([
    ...
    { externalId: "usr-011", username: "n.petrov", email: "n.petrov@atlasbridge.local", displayName: "Nikolai Petrov", role: "Evidence Reviewer", status: "active", mfaStatus: "enabled", lastActive: d(2), createdAt: d(55), groups: (["External Auditors"]), loginMethod: "SSO" },
    { externalId: "usr-012", username: "c.dubois", email: "c.dubois@atlasbridge.local", displayName: "Claire Dubois", role: "Evidence Reviewer", status: "active", mfaStatus: "enabled", lastActive: d(3), createdAt: d(50), groups: (["External Auditors"]), loginMethod: "SSO" },
  ...
  await db.insert(apiKeys).values([
    ...
    { externalId: "key-004", name: "Evidence Export Tool", prefix: "ab_comp_", scopes: (["audit.view", "audit.export", "evidence.view"]), status: "active", createdBy: "m.chen", createdAt: d(20), expiresAt: futureD(50), lastUsed: d(2), rateLimit: 100 },
  ...
  await db.insert(securityPolicies).values([
    ...
    { externalId: "sp-008", name: "Audit Log Immutability", category: "Governance", description: "Prevent modification or deletion of audit log entries", enabled: true, value: "Write-once, append-only", severity: "critical" },
    ...
    { externalId: "sp-015", name: "Data Export Approval", category: "Data Protection", description: "Require approval for bulk data exports from audit and evidence", enabled: false, value: "Disabled", severity: "info" },
  ]);
  ...
  await db.insert(notifications).values([
    ...
    { externalId: "notif-006", channel: "email", name: "Evidence Reports", enabled: true, destination: "evidence@atlasbridge.local", events: (["evidence.report", "audit.export"]), minSeverity: "info", lastDelivered: d(7) },
  ...
  await db.insert(rbacPermissions).values([
    ...
    { externalId: "perm-008", resource: "Audit", actions: (["view", "export", "configure"]), description: "Audit log access and retention settings", category: "Governance" },
    ...
    { externalId: "perm-012", resource: "Evidence", actions: (["view", "configure", "export"]), description: "Evidence configuration and reporting", category: "Governance" },
